...
assert(html.includes('makePlayer({ id: `ai${i}`, name: `AI ${i}`, color: PLAYER_COLORS[i], isAI: true })'), 'single-player AIs must be flagged as AI so they can act/respond automatically');
