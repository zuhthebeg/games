...
assert(html.includes('function rematchSingleGame'), 'single-player victory modal should support rematch');
...
assert(html.includes('다시 하기'), 'single-player winner modal should expose rematch action');
