...
const I18N = {
  ko: {
    ...
    xpromoT: '🦊 내 얼굴은 무슨 동물상?', xpromoS: '사진 한 장으로 얼굴 468개 점을 재서 39종 중에 찾아드려요',
  ...
  en: {
    ...
    xpromoT: '🦊 Which animal is your face?', xpromoS: '468 facial points measured on your phone — find your match among 39 animals',
  ...
  ja: {
    ...
    xpromoT: '🦊 あなたの顔はどの動物？', xpromoS: '写真1枚で顔の468点を実測し、39種から探します',
  ...
  es: {
    ...
    xpromoT: '🦊 ¿Qué animal es tu cara?', xpromoS: '468 puntos faciales medidos en tu móvil — encuentra tu tipo entre 39 animales',
  ...
  tw: {
    ...
    xpromoT: '🦊 我的臉是哪種動物？', xpromoS: '一張照片實測臉部468個點，從39種動物臉中找出你的那一種',
    title: '聲音KTV', room: 'NO.',
  ...
  id: {
    ...
    xpromoT: '🦊 Wajahmu mirip hewan apa?', xpromoS: '468 titik wajah diukur di ponselmu — temukan tipemu dari 39 hewan',
