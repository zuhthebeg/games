...
assert(indexHtml.includes("multi: ['poker', 'catan', 'blackjack', 'connect4', 'gomoku', 'rps']"), 'popular/multi config should include catan and blackjack');
...
assert(urls.some(u => u.includes('/catan/')), 'catan should still exist');
