...
assert(index.includes("multi: ['poker', 'pingtan', 'catan', 'blackjack', 'connect4', 'gomoku', 'rps']"), 'home multi category should include pingtan');
assert(index.includes("board: ['pingtan', 'catan', 'connect4', 'gomoku']"), 'board category should include pingtan');
