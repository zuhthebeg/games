...
const SharedWallet = {
    ...
    _updateUI() {
        ...
        const homeBtn = `<a href="/" style="display:flex;align-items:center;justify-content:center;width:28px;height:28px;border-radius:8px;background:rgba(255,255,255,0.1);text-decoration:none;color:#fff;flex-shrink:0;">
        ...
        if (this.isLoggedIn) {
            ...
            bar.innerHTML = `
                ...
                <div style="display:flex;align-items:center;gap:8px;margin-left:auto;">
                    <span style="color:#ffd700;font-weight:600;font-size:13px;">💰 ${this.gold.toLocaleString()}G</span>
