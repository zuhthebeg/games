        ...
        try {
            ...
            if (tokenUserId) {
                ...
                if (!payload.isAnonymous) {
                    const userRes = await fetch(`${this.AUTH_API}/me`, { headers: { Authorization: `Bearer ${token}` } });
                    if (userRes.ok) {
                ...
                const dataRes = await fetch(this.DATA_API, { headers: { Authorization: `Bearer ${token}` } });
                if (dataRes.ok) {
