                ...
                <div class="mp-screen">
                    ...
                    <div class="mp-card" style="padding:10px;">
                        <div style="display:flex;gap:8px;align-items:stretch;">
                            <input type="text" id="mp-room-code" 
                                   placeholder="방 코드 6자리" maxlength="6"
                                   style="flex:1;padding:12px;border-radius:8px;border:2px solid #334155;background:#0f172a;color:#fff;font-size:1.1rem;text-align:center;letter-spacing:4px;text-transform:uppercase;outline:none;min-width:0;">
                            <button class="mp-btn primary" data-action="join" style="padding:12px 20px;font-size:0.95rem;">입장</button>
                            <button class="mp-btn" data-action="qr-scan" style="padding:12px 16px;font-size:1.5rem;line-height:1;">📷</button>
                        </div>
                    </div>
                    ...
                    <div class="mp-card" style="padding:10px;">
                        ${isLoggedIn ? `
                            <div style="display:flex;gap:8px;align-items:stretch;">
                                <input type="text" id="mp-room-name" 
                                       placeholder="${randomPlaceholder}" maxlength="20"
                                       style="flex:1;padding:10px 12px;border-radius:8px;border:2px solid #334155;background:#0f172a;color:#fff;font-size:0.95rem;outline:none;min-width:0;">
                                <label style="display:flex;align-items:center;gap:4px;color:#94a3b8;font-size:0.8rem;white-space:nowrap;cursor:pointer;padding:0 4px;">
                                    <input type="checkbox" id="mp-public" checked style="accent-color:#4ecca3;width:16px;height:16px;">공개
                                </label>
                                <button class="mp-btn primary" data-action="create" style="padding:10px 16px;font-size:0.9rem;white-space:nowrap;">방 만들기</button>
                            </div>
                        ` : `
                            <div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;">
                                <span style="color:#64748b;font-size:0.85rem;">로그인하면 방을 만들 수 있어요</span>
                                <button class="mp-btn primary" onclick="SharedWallet.showLogin()" style="padding:8px 14px;font-size:0.85rem;">로그인</button>
                            </div>
                        `}
                    </div>
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;margin:8px 0 4px;">
                        <span style="color:#94a3b8;font-size:0.8rem;font-weight:600;">공개 방</span>
                        <button class="mp-btn" data-action="random" style="padding:4px 12px;font-size:0.8rem;">🎲 랜덤 매칭</button>
                    </div>
                    
                    <!-- 방 목록 -->
                    <div id="mp-room-list" style="flex:1;overflow-y:auto;max-height:45vh;">
                        <div style="text-align:center;color:#64748b;padding:16px;font-size:0.85rem;">로딩 중...</div>
                    </div>
                </div>
            </div>
        `;
