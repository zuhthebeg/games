                ...
                <div class="mp-screen">
                    ...
                    <div style="display:flex;gap:6px;margin-bottom:12px;">
                        <input type="text" class="mp-input" id="mp-room-code" 
                               placeholder="방 코드 입력" maxlength="6" style="flex:1;text-align:center;font-size:1.1rem;letter-spacing:3px;text-transform:uppercase;">
                        <button class="mp-btn" data-action="join" style="padding:8px 16px;white-space:nowrap;">입장</button>
                        <button class="mp-btn" data-action="qr-scan" style="padding:8px 12px;font-size:1.4rem;line-height:1;" title="QR 스캔">📷</button>
                    </div>
                    ...
                    <div style="display:flex;gap:6px;margin-bottom:12px;">
                        ${isLoggedIn ? `
                            <input type="text" class="mp-input" id="mp-room-name" 
                                   placeholder="${randomPlaceholder}" maxlength="20" style="flex:1;">
                            <label style="display:flex;align-items:center;gap:4px;color:#64748b;font-size:0.75rem;white-space:nowrap;cursor:pointer;">
                                <input type="checkbox" id="mp-public" checked style="accent-color:#4ecca3;"> 공개
                            </label>
                            <button class="mp-btn primary" data-action="create" style="padding:8px 16px;white-space:nowrap;">방 만들기</button>
                        ` : `
                            <div style="flex:1;display:flex;align-items:center;color:#64748b;font-size:0.85rem;">로그인 후 방 만들기 가능</div>
                            <button class="mp-btn primary" onclick="SharedWallet.showLogin()" style="padding:8px 16px;">로그인</button>
                        `}
                    </div>
                    
                    <!-- 방 목록 -->
                    <div id="mp-room-list" style="flex:1;overflow-y:auto;max-height:50vh;">
                        <div style="text-align:center;color:#64748b;padding:20px;font-size:0.9rem;">로딩 중...</div>
                    </div>
                    
                    <button class="mp-btn" data-action="random" style="width:100%;margin-top:8px;padding:10px;">🎲 랜덤 매칭</button>
                </div>
            </div>
        `;
