...
class MultiplayerUI {
    ...
    _renderLobby() {
        ...
        const savedNick = localStorage.getItem(`${this.gameType}_nickname`) || '';
                    ...
                    <div class="mp-card">
                        <div class="mp-field">
                            ...
                            <input type="text" class="mp-input" id="mp-nickname" 
                                   placeholder="2자 이상" maxlength="12" value="${savedNick}">
                        </div>
        ...
        this.container.querySelector('[data-action="back"]').onclick = () => this._renderModeSelect();
    ...
    async _handleJoin(btn) {
        ...
        try {
            ...
            await this.client.joinRoom(code);
            this.isHost = false;
    ...
    async _handleReady(btn) {
        ...
        try {
            ...
            await this.client.setReady(newReady);
    ...
    _handleEvent(type, data) {
        if (type === 'room_destroyed') {
            ...
            if (data.userId !== myId) {
                ...
                setTimeout(() => this.goToWaitingRoom(), 1000);
            }
        }
