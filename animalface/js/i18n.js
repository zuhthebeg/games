...
(function (global) {
  ...
  var UI = {
    ko: {
      ...
      privacyT: '사진은 절대 서버에 저장되지 않습니다',
      privacyS: '얼굴 분석은 100% 이 기기 안에서만 이뤄집니다. 사진도, 얼굴 데이터도 전송·저장되지 않아요. 서버로 가는 건 결과 동물 종류 하나뿐입니다.',
    ...
    en: {
      ...
      privacyT: 'Your photo is never stored on any server',
      privacyS: 'Face analysis runs 100% on your device. Neither the photo nor any face data is uploaded or stored. The only thing sent is which animal you got.',
    ...
    ja: {
      ...
      privacyT: '写真はサーバーに保存されません',
      privacyS: '顔の解析は100%この端末内で行われます。写真も顔データも送信・保存されません。送るのは結果の動物種だけです。',
    ...
    tw: {
      ...
      privacyT: '照片絕不會儲存在伺服器上',
      privacyS: '臉部分析100%在你的裝置上完成。照片與臉部資料都不會上傳或儲存，送出的只有結果的動物種類。',
